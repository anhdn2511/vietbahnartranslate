...
class TextRecognizer(private val onTextFound: (String) -> Unit) {
    private val TAG = TextRecognizer::class.java.simpleName
    private val textRecognitionClient = TextRecognition.getClient(TextRecognizerOptions.DEFAULT_OPTIONS)
    ...
    fun recognizeImageText(image: Image, rotationDegrees: Int, onResult: (Boolean) -> Unit) {
        ...
        textRecognitionClient
            ...
            .addOnFailureListener {error ->
                Log.d(TAG, "Failed to recognize image test")
